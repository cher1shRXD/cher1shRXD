...
export const metadata: Metadata = {
  title: "개인정보처리방침 | cher1shRXD",
  description: "cher1shRXD 포트폴리오의 개인정보처리방침",
  openGraph: {
    title: "개인정보처리방침 | cher1shRXD",
    description: "cher1shRXD 포트폴리오의 개인정보처리방침",
    type: "website",
    url: "https://cher1shrxd.me/privacy",
  },
};
        ...
        <Reveal threshold={0.1} triggerOnce>
          <section>
            <p className="mb-4 leading-relaxed">
              cher1shRXD 포트폴리오(이하 &lsquo;본 사이트&rsquo;)는 이용자의 개인정보를 중요시하며, 「개인정보 보호법」 등 관련 법령을 준수하고 있습니다. 
          ...
          <section>
            ...
            <div className="ml-4 space-y-2">
              ...
              <div className="mt-4 space-y-1">
                <p><strong className="text-text">개인정보 보호책임자:</strong> 김태우</p>
                <p><strong className="text-text">이메일:</strong> cher1shrxd@naver.me</p>
                <p><strong className="text-text">연락처:</strong> 010-4890-1466</p>
              </div>
            </div>
          </section>
        </Reveal>
