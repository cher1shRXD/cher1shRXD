...
const Intro = () => {
  ...
  return (
    <div
      ref={ref}
      className={`w-full h-[calc(95vh-5rem)] md:h-[calc(95vh-10rem)] flex flex-col items-center justify-center bg-surface transition-[margin] duration-700 sticky top-44 ${
