  ...
  return (
    <Reveal>
      <div className="w-full flex flex-col items-start gap-4 sm:gap-5 md:gap-6 lg:gap-7 xl:gap-8">
        <h3 className="section-label text-lg sm:text-xl lg:text-2xl font-black">자격증</h3>
        <div className="flex flex-col md:flex-row gap-2 sm:gap-3 md:gap-4 w-full md:w-auto">
          {licenses.map((license, index) => (
            <div
              key={index}
              className="hard-panel bg-surface p-3 px-4 sm:px-5 md:p-4 md:px-6 lg:px-7 xl:px-8 flex items-center justify-between hover:-translate-y-1 hover:bg-lime transition-all gap-2 sm:gap-3 md:gap-4">
